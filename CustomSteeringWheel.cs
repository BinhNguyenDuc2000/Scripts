...
public class CustomSteeringWheel : MonoBehaviour
{
    ...
    [SerializeField] private int damperforce;
    ...
    public void StartSteeringWheel()
    {
    ...
    public float GetBreak()
    {
        ...
        {
            rec = LogitechGSDK.LogiGetStateUnity(0);
            return -(rec.rglVSlider[0] - 32767) / (32768f * 2);
        }
        else
        {
            return 0;
    ...
    void Update()
    {
        ...
        if (LogitechGSDK.LogiUpdate() && LogitechGSDK.LogiIsConnected(0))
        {
            ...
            if (Input.GetKeyUp(KeyCode.S))
            {
                ...
                {
                    LogitechGSDK.LogiPlaySpringForce(0, 0, 100, 50);
                    activeForceAndEffect[0] = "Spring Force\n ";
                }
            }
